              ...
              <div className={styles.benefits}>
                {benefits.map((benefit) => (
                  <div key={benefit.icon} className={styles.benefit}>
                    <span className={`material-symbols-outlined ${styles.benefitIcon}`} style={{ fontVariationSettings: "'FILL' 1" }}>
                      {benefit.icon}
                    </span>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              <div className={styles.terms}>
                ...
                <label htmlFor="terms" className={styles.termsLabel}>
                  Al crear una cuenta, acepto los <a href="#" className={styles.termsLink}>Términos de Servicio</a> y la <a href="#" className={styles.termsLink}>Política de Privacidad</a> de Iron Gear.
                </label>
              </div>
              ...
              <div className={styles.footer}>
                <p className={styles.footerText}>
                  ...
                  <a href="#" className={styles.footerLink} onClick={(e) => { e.preventDefault(); onNavigate?.('account'); }}>Inicia sesión</a>
                </p>
              </div>
            </form>
          </div>
