        ...
        <main className={styles.mainContent}>
          <div className={styles.heroBanner}>
            ...
            <div className={styles.heroContent}>
              <span className={styles.heroLabel}>Performance</span>
              <h1 className={styles.heroTitle}>Suplementos</h1>
              <p className={styles.heroDescription}>Suplementos deportivos de primera calidad para optimizar tu rendimiento y recuperación.</p>
            </div>
          </div>
