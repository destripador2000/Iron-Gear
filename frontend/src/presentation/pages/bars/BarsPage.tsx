        ...
        <main className={styles.mainContent}>
          <div className={styles.heroBanner}>
            ...
            <div className={styles.heroContent}>
              <span className={styles.heroLabel}>Olympic & Professional</span>
              <h1 className={styles.heroTitle}>Barras</h1>
              <p className={styles.heroDescription}>Barras olimpicas y profesionales de alta resistencia para entrenamiento de fuerza avanzado.</p>
            </div>
          </div>
